...
class IngredientsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ingredient" do
    assert_difference('Ingredient.count') do
      post ingredients_url, params: { ingredient: { ingredienttype: @ingredient.ingredienttype, name: @ingredient.name } }
    end
  ...
  test "should update ingredient" do
    patch ingredient_url(@ingredient), params: { ingredient: { ingredienttype: @ingredient.ingredienttype, name: @ingredient.name } }
