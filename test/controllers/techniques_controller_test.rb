...
class TechniquesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create technique" do
    assert_difference('Technique.count') do
      post techniques_url, params: { technique: { desc: @technique.desc, name: @technique.name } }
    end
  ...
  test "should update technique" do
    patch technique_url(@technique), params: { technique: { desc: @technique.desc, name: @technique.name } }
